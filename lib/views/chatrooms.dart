...
import 'package:elbaya_flutter/helper/constants.dart';
...
import 'package:elbaya_flutter/views/chat.dart';
import 'package:elbaya_flutter/views/search.dart';
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: Colors.pinkAccent[400],
      ...
      floatingActionButton: FloatingActionButton(
        child: Icon(Icons.search, color: Colors.pinkAccent[400],),
        onPressed: () {
          Navigator.push(
